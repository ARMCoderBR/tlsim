...
end_ls245:
    ...
    for (i = 0; i < 8; i++){
        ...
        if (a->outb_o[i] != a->outb[i]){
            ...
            a->outb_o[i] = a->outb[i];
            e.event_handler_root = a->outq_event_handler_root[8+i];
            e.value = a->outb[i];
            event_insert(&e);
        }
    }
...
////////////////////////////////////////////////////////////////////////////////
static void ls245_update_a(ls245 *a, int val, int timestamp, int index){
...
////////////////////////////////////////////////////////////////////////////////
static void ls245_update_b(ls245 *a, int val, int timestamp, int index){
...
ls245 *ls245_create(){
    ...
    for (i = 0; i < 8; i++){
        ...
        b->outq_event_handler_root[8+i] = NULL;
    }
...
////////////////////////////////////////////////////////////////////////////////
static void ls245_connect_a(ls245 *source, void *dest, void (*dest_event_handler)(void *dest, int val, int timestamp), int index){
...
////////////////////////////////////////////////////////////////////////////////
static void ls245_connect_b(ls245 *source, void *dest, void (*dest_event_handler)(void *dest, int val, int timestamp), int index){

    new_ehandler(&source->outq_event_handler_root[8+index], dest, dest_event_handler);
