...
ram_ctl *ram_ctl_create(char *name){
    ...
    ram_ctl *ram = malloc (sizeof(ram_ctl));
    if (!ram) return ram;
...
void (*ram_ctl_in_dataN[])(void *dest, int *valptr, int timestamp) = {

        (void*)ram_ctl_in_data0,
        (void*)ram_ctl_in_data1,
        (void*)ram_ctl_in_data2,
        (void*)ram_ctl_in_data3,
        (void*)ram_ctl_in_data4,
        (void*)ram_ctl_in_data5,
        (void*)ram_ctl_in_data6,
        (void*)ram_ctl_in_data7,
};
...
void (*ram_ctl_in_addrN[])(void *dest, int *valptr, int timestamp) = {

        (void*)ram_ctl_in_addr0,
        (void*)ram_ctl_in_addr1,
        (void*)ram_ctl_in_addr2,
        (void*)ram_ctl_in_addr3,
};

////////////////////////////////////////////////////////////////////////////////
board_object *ram_ctl_board_create(ram_ctl *ram, int key, char *name){
