...
void progctr_in_clear_from(void (*connect_fn)(void *source, void *dest, void (*dest_event_handler)(void *dest, int *valptr, int timestamp)),
                        void *from, progctr *dest);

void progctr_in_enable_from(void (*connect_fn)(void *source, void *dest, void (*dest_event_handler)(void *dest, int *valptr, int timestamp)),
                        void *from, progctr *dest);

void progctr_in_clock_from(void (*connect_fn)(void *source, void *dest, void (*dest_event_handler)(void *dest, int *valptr, int timestamp)),
                        void *from, progctr *dest);
...
void progctr_in_enp(progctr *dest, int *valptr, int timestamp);

void progctr_in_ent(progctr *dest, int *valptr, int timestamp);
